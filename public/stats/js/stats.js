...
const currentUserActivityLink = document.querySelector("#currentUserActivityLink");
currentUserActivityLink.setAttribute("href", `./activity-histogram.html?user_id=${getId()}`);
